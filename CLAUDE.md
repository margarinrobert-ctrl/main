...
trade in profit. **AND THE OFFSET IS THE CLEANEST WIN-RATE ILLUSION MEASURED HERE**: identical
signals, breakeven at 50, offset 0 vs +10 reads **+0.011307 against +0.011322 %/trade -- a 0.13%
difference -- at a win rate of 0.2207 against 0.5282**, because an exit at the fill is a loss after
a 2.29-point round turn and an exit ten points beyond it is a win. Nothing about the trades
changed. Every paired delta is INSIDE its own MDE (0 of 60 outside) and **0 of 72 cells clear a
...
after the order is written and exactly when the research walker arms. Parity 10 of 10 cells at
trade count 1.000, same exit bar 0.979-0.997, gap -0.37 to +0.07 pts/trade.
