...
export const STRATEGIES: Strategy[] = [orb, volBreakout, vwapFade, ouReversion, sweepReversal, trendPullback, timeOfDayControl];
...
export { orb, volBreakout, vwapFade, ouReversion, sweepReversal, trendPullback, timeOfDayControl };
